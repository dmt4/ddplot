...
const int MAX_PLOTS = 100;        // max. number of plots inserted simultaneously in the tabWidget
...
const int MIXED = 3;              // mixed component given by a projection vector
